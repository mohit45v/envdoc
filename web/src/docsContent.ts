export const docsMarkdown = `# 📖 envdoc
...
## ✨ Features
- 🚀 **Zero Config**: Just run \`npx envdoc-ai\` in your project root.
- 🧠 **Smart Dictionary**: Comes with a built-in dictionary of common environment variables for instant descriptions.
